...
const EXPERIENCE_LEVELS = [
  ...
  { value: "advanced", label: "Advanced", description: "Experienced enthusiast" },
];
        ...
        <Card className="border-none shadow-2xl">
          <CardHeader className="text-center space-y-2 pb-4">
            ...
            <CardDescription className="text-base">
              {t("onboarding.subtitle", "Just a few more details to get you started")}
            </CardDescription>
          </CardHeader>
            ...
            >
              ...
              {currentStep === 1 && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                  ...
                  <RadioGroup
                    value={selectedRole}
                    onValueChange={(value) => setValue("role", value as "renter" | "owner")}
                  >
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            <Label htmlFor="renter" className="text-base font-medium cursor-pointer">
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            <Label htmlFor="owner" className="text-base font-medium cursor-pointer">
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="location"
                      {...register("location")}
                      placeholder={t("signup.renter.step2.location_placeholder")}
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <Label htmlFor={level.value} className="text-sm font-medium cursor-pointer">
                                {t(`signup.renter.experience_levels.${level.value}`, level.label)}
                              </Label>
                              <p className="text-xs text-muted-foreground">
                                {t(`signup.renter.experience_levels.${level.value}_description`, level.description)}
                              </p>
                            </div>
                          </div>
                        ))}
